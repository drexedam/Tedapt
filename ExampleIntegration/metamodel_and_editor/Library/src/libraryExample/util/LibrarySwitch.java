 ...
 * <!-- end-user-doc -->
 * @see libraryExample.LibraryPackage
 * @generated
 */
public class LibrarySwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LibraryPackage.SCHOOL_LIBRARY: {
			...
			case LibraryPackage.ASSET: {
				Asset asset = (Asset)theEObject;
				Object result = caseAsset(asset);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LibraryPackage.SCHOOL_BOOK: {
