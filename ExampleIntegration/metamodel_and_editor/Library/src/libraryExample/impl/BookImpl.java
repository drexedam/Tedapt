 ...
 * <ul>
 *   <li>{@link libraryExample.impl.BookImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link libraryExample.impl.BookImpl#getPages <em>Pages</em>}</li>
 *   <li>{@link libraryExample.impl.BookImpl#getWriter <em>Writer</em>}</li>
 *   <li>{@link libraryExample.impl.BookImpl#getCategory <em>Category</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookImpl extends MinimalEObjectImpl.Container implements Book {
	...
	public void setWriter(Writer newWriter) {
		if (newWriter != writer) {
			...
			if (writer != null)
				msgs = ((InternalEObject)writer).eInverseRemove(this, LibraryPackage.WRITER__BOOKS, Writer.class, msgs);
			if (newWriter != null)
				msgs = ((InternalEObject)newWriter).eInverseAdd(this, LibraryPackage.WRITER__BOOKS, Writer.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LibraryPackage.BOOK__WRITER:
				if (writer != null)
					msgs = ((InternalEObject)writer).eInverseRemove(this, LibraryPackage.WRITER__BOOKS, Writer.class, msgs);
				return basicSetWriter((Writer)otherEnd, msgs);
		}
