 ...
 * <ul>
 *   <li>{@link libraryExample.impl.WriterImpl#getName <em>Name</em>}</li>
 *   <li>{@link libraryExample.impl.WriterImpl#getBooks <em>Books</em>}</li>
 *   <li>{@link libraryExample.impl.WriterImpl#getLastname <em>Lastname</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WriterImpl extends MinimalEObjectImpl.Container implements Writer {
	...
	public EList getBooks() {
		if (books == null) {
			books = new EObjectWithInverseResolvingEList(Book.class, this, LibraryPackage.WRITER__BOOKS, LibraryPackage.BOOK__WRITER);
		}
		return books;
	}
	...
	public void setLastname(String newLastname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.WRITER__LASTNAME, oldLastname, lastname));
	}
