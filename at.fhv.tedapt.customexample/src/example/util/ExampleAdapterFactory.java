...
public class ExampleAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExampleSwitch<Adapter> modelSwitch =
		new ExampleSwitch<Adapter>() {
			@Override
			public Adapter caseExampleClass(ExampleClass object) {
				return createExampleClassAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link example.ExampleClass <em>Class</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExampleClassAdapter() {
		return null;
	}
